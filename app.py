...
with st.sidebar:
    ...
    selected = option_menu(
        menu_title=None,
        options=["Dashboard", "Upload", "Profiling", "Machine Learning", "User Input", "Download"],
...
if selected == "Machine Learning":
    ...
    sns.scatterplot(x=x_train['mean area'],
                    y=x_train['mean smoothness'], hue=y_train)
    sns.scatterplot(x=x_train_scaled['mean area'],
                    y=x_train_scaled['mean smoothness'], hue=y_train)
    min_test = x_test.min()
